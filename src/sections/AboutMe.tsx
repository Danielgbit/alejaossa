...
const AboutMe = () => {
  return (
    <section className="flex my-50 px-5">
      <div className="flex flex-col relative">
        <span className="text-right font-ballet text-7xl tracking-title absolute right-[-15%] top-[-15%]">Bienvenido</span>
        <Image
          src={avatar}
          width={500}
          height={500}
      ...
      <div className="max-w-3xl mx-auto px-6 text-center pl-20">
        <h2 className="text-4xl font-cormorant font-light mb-6">Sobre mí</h2>
