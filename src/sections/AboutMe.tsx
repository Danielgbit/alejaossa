...
const AboutMe = () => {
  return (
    <section className="flex my-60 px-5 bg-dark-04 pt-50 pb-20">
      <div className="flex flex-col relative">
        <span className="text-right font-ballet text-light-02 text-7xl tracking-title absolute right-[-15%] top-[-20%]">Bienvenido</span>
        <Image
          src={avatar}
          width={500}
          height={500}
      ...
      <div className="max-w-3xl mx-auto px-6 text-center pl-20">
        <h2 className="text-4xl text-light-02 font-cormorant font-light mb-6">Sobre mí</h2>
        <Motivational children="Encontrando la esencia" className="text-xl rounded-xl mt-5 mb-10"/>
        <p className="text-lg italic leading-relaxed text-light-02 font-semilight">
